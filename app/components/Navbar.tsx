                ...
                <div className="nav-links">
                    <div className="nav-dropdown">
                        ...
                        <div className="nav-dropdown-content">
                            ...
                            <Link href="/youtube-sponsorship-calculator/" className={`nav-link ${pathname === '/youtube-sponsorship-calculator/' ? 'active' : ''}`}>Sponsorship Calculator</Link>
                            ...
                            <Link href="/youtube-watch-time-calculator/" className={`nav-link ${pathname === '/youtube-watch-time-calculator/' ? 'active' : ''}`}>Watch Time Calculator</Link>
                            <Link href="/youtube-upload-planner/" className={`nav-link ${pathname === '/youtube-upload-planner/' ? 'active' : ''}`}>Upload Planner</Link>
                        </div>
                    </div>
            ...
            <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
                <div className={`mobile-dropdown ${mobileDropdownOpen ? 'open' : ''}`}>
                    ...
                    <div className="mobile-submenu">
                        ...
                        <Link href="/youtube-channel-valuation-calculator/" className="mobile-link mobile-sublink" onClick={() => setMobileMenuOpen(false)}>Channel Valuation Calculator</Link>
                        <Link href="/youtube-sponsorship-calculator/" className="mobile-link mobile-sublink" onClick={() => setMobileMenuOpen(false)}>Sponsorship Calculator</Link>
                    </div>
                </div>
